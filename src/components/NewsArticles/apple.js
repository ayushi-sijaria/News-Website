...
const AppleNewsArticles = () =>
 {
      ...
      useEffect(() =>{
          setIsLoading(true)
          axios.get('/everything?q=apple&from=2021-04-28&to=2021-04-28&sortBy=popularity&apiKey=9f912effda464f639b6b0ba2079d6ba3')
                    .then(response => {
...
export default AppleNewsArticles